<div class="bg-white  shadow-sm sm:rounded-lg">
    <div class="bg-gray-100 dark:bg-gray-900">
        ...
        <x-form id="screen-form" x-ref="screeningForm" direction='col' wire:submit.prevent="createOrUpdate()">
            <div class=" bg-orange-500  px-1 sticky top-16 z-30">
                <div class="flex items-center flex-wrap gap-3 mb-1 py-[0.21rem] px-1 rounded-b-md bg-gray-200 dark:bg-gray-900">
                    ...
                    <div class="flex justify-end gap-2 md:gap-3 grow md:grow-0">
                        ...
                        @endIf
                        @if($formState=='edit')
                        <x-primary-blue-button class=" disabled:bg-blue-400" type="submit">
                            <x-icons.pencil-alt size="4" />
                            Update
                        </x-primary-blue-button>
                        @endIf
                    ...
                    <div class="dark:border-0 {{ $previewMode == 1 ? 'border-2 border-red-400 dark:border-gray-700 rounded-md' : '' }}">
                                    ...
                                    <div class="flex flex-col md:flex-row gap-0 md:gap-2 my-2 items-center">
                                        ...
                                        <div class="flex flex-col w-full">
                                            <x-select-input wire:change="determineGeneralEligiblity()"
                                                id="had total hysterectomy" :previewmode="$previewMode"
                                                :disabled="false" name="had total hysterectomy"
                                                :options="$trueOrFalse" />
                         ...
                         {{ $previewMode == 1 ? 'text-white py-2 align-middle' : '' }}">
                            ...
                            <div
                                ...
                                <div class="flex flex-col md:flex-row gap-0 md:gap-2 my-2 items-center">
                                    ...
                                    <div class="flex flex-col w-full">
                                        <x-select-input-two wire:change="determineCurrentEligiblity"
                                ...
                                !empty($days_since_last_menstruation_period)))
                                <div class="flex flex-col md:flex-row gap-0 md:gap-2 my-2 items-center">
                        ...
                        <div name="symptoms_indicating_advanced_illness" id="advanced-illness-symptoms"
                            ...
                            <div
                                ...
                                @if ($sign_of_advanced_illness_symptoms == $trueOrFalse[0] || $previewMode == 1 && !empty($symptomsIndicatingAdvancedIllness))
                            ...
                            <div class="dark:bg-gray-800 px-3 {{ $previewMode == 1 ? 'rounded-2xl pt-2 border-red-400 bg-white' : '' }}">
                                ...
                                <div class="flex flex-col md:flex-row gap-0 md:gap-2 my-2 items-center">
                                    ...
                                    <div class="flex flex-col w-full">
                                        <x-select-input-three
                                            wire:change="updateSelectedRisks($event.target.value,$event.target.name)"
                                            :previewmode="$previewMode" name="smoke cigarettes"
                                            :options="$ciga_smoker" />
                        ...
                        <div name="client_referral" id="client-referral"
                            ...
                            <div class="dark:bg-gray-800 px-3 {{ $previewMode == 1 ? 'rounded-2xl pt-2 border-red-400 bg-white' : '' }}">
                                ...
                                <div class="flex flex-col md:flex-row gap-0 md:gap-2 my-2 items-center">
                                    ...
                                    <div class="flex flex-col w-full">
                                        <x-select-input wire:change="resetReferralSelctFields"
                                            :previewmode="$previewMode" :disabled="false"
                                            name="client referred for treatment" :options="$trueOrFalse" />
        ...
        <div class="flex px-8 py-2 sticky bottom-0 left-0 right-0 {{$formState=='edit'? 'hidden':''}} {{$formState=='view'? 'hidden':''}}">
            ...
            <div class="flex gap-4">
                ...
                <div>
                    ...
                    <x-primary-button id="next-btn" type="button" wire:click.prevent="validateForms()">
                        Next
                    </x-primary-button>
                    @endif
                    @if ($previewMode == 1)
                    <x-primary-button id="back-btn" type="button" wire:click="disablePreviewMode">
                        Back
                    </x-primary-button>
                    @endif
                </div>
        ...
        <div class="bg-green-400 hidden">
            <p>SESSIONS: @if (session()->has('invalid_bio_form')) {{ var_dump(session('invalid_bio_form'))}} @endif
            </p>
